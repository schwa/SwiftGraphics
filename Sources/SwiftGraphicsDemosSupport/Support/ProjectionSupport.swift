...
public struct LegacyCamera {
    public var transform: Transform

    // TODO: Deprecate. We can't generate this from any transform. Maybe move target into transform rotation?
...
extension LegacyCamera: Equatable {
}

extension LegacyCamera: Sendable {
}

public extension LegacyCamera {
    var heading: Angle {
        get {
