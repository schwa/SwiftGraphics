...
//
//    @State
//    private var cone = CameraCone(apex: [0, -1, 0], axis: [0, 1, 0], h1: 1, r1: 0.5, r2: 1, h2: 2)
//
//    var body: some View {
...
//                        VStack {
//                            Slider(value: $cone.h1, in: 0...10)
//                            TextField("apexToTopBase", value: $cone.h1, format: .number)
//                                .labelsHidden()
//                        }
//                    }
//
...
//                        VStack {
//                            Slider(value: $cone.r1, in: 0...5)
//                            TextField("topBaseRadius", value: $cone.r2, format: .number)
//                                .labelsHidden()
//                        }
//                    }
//
...
//                        VStack {
//                            Slider(value: $cone.r2, in: 0...5)
//                            TextField("bottomBaseRadius", value: $cone.r2, format: .number)
//                                .labelsHidden()
//                        }
//                    }
//
...
//                            TextField("height", value: $cone.h2, format: .number)
//                                .labelsHidden()
//                        }
//                    }
//                }
...
//        let topCenter = cone.apex + cone.axis * cone.h1
//        let bottomCenter = topCenter + cone.axis * cone.h2
//
